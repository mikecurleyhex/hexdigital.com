...
<section id="section-header-work" class="section-header">
<div class="row">
<div class="large-8-centered small-8-centered columns fullcolumns">
	<div class="verticalcenterwrap">
	<div class="verticalcenterblock">	
		<h1 class="textblack textxxl textcenter textlight maintitle">we do the hard work<br/>so you don't have to . . .</h1>

		<div class="clear50"></div>
		<div class="clear30"></div>

		<a href="#letsgo" class="hexbutton hexbuttonlight">Show me the monies</a>
	...
	<div class="verticalcenterblock">
		...
		<div class="clear50"></div>
				...
				<ul class="large-block-grid-3 small-block-grid-1 workitems lightlinksnounderline">
					...
					<?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts("post_type=work&showposts=6&paged=$paged"); ?>
