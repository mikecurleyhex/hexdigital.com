					...
					<div class="large-10 large-centered columns">
						...
						<div class="clear50"></div>
							...
							<ul class="large-block-grid-3 small-block-grid-1 workitems lightlinksnounderline">
								...
								<?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts("post_type=marketing&showposts=6&paged=$paged" ); ?>
									
								<?php while (have_posts()) : the_post(); ?> 
							        <li class="realeasy">
							        	<a href="<?php the_permalink() ?>" class="workitem lightlinks realeasy" style="background:url('<?php $image_id = get_post_thumbnail_id(); $image_url = wp_get_attachment_image_src($image_id, 'work-thumb'); echo $image_url = $image_url[0]; ?>');">
